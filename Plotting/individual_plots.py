...
def indiv_metal_mass_plot(Mbin_dict, MLHbbin_dict, restrictMTO = False, revised = False, err_bars = False):
    ...
    if restrictMTO:
        Mbin_pdf_pages = PdfPages(Mbin_dict['path'] + 'combined_' + 
                                  filename_dict['indv_derived_prop'].replace('.tbl', 'constMTO.pdf'))
        MLHbbin_pdf_pages = PdfPages(MLHbbin_dict['path'] + 'combined_' + 
                                     filename_dict['indv_derived_prop'].replace('.tbl', 'constMTO.pdf'))
    else:
        Mbin_pdf_pages = PdfPages(Mbin_dict['path'] + 'combined_' + 
                                  filename_dict['indv_derived_prop'].replace('.tbl', '.pdf'))
        MLHbbin_pdf_pages = PdfPages(MLHbbin_dict['path'] + 'combined_' + 
                                     filename_dict['indv_derived_prop'].replace('.tbl', '.pdf'))
    ...
    print('Number of mass-LHbeta bin individual sources plotted:', 
          len(MLHbbin_dict['indiv_logM'][MLHbbin_dict['indiv_detect']]))
